...
const AccountCreatedSuccessScreen: React.FC = () => {
    ...
    // Success icon image from Figma
    const successIconUrl = 'https://www.figma.com/api/mcp/asset/e68fdc5d-26cc-4c1f-b46e-9121cffc2dcd';
    // Background header image from Figma
    const headerImageUrl = 'https://www.figma.com/api/mcp/asset/62992aae-2139-4fe3-a51f-3f18a29ef13a';
